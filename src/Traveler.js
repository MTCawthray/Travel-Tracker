class Traveler {
  ...
  getTripCost(tripID) {
    if (this.travelerTrips.find(trip => trip.id === tripID)) {
      ...
      let lodgingCost = destination.estimatedLodgingCostPerDay * bookedTrip.duration;
      let flightCost = destination.estimatedFlightCostPerPerson * bookedTrip.travelers;
